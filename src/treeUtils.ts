...
import { IJSONKifuFormat, IMoveFormat, IMoveMoveFormat, ITimeFormat } from 'json-kifu-format/dist/src/Formats';
...
export function createKifuTreeNode(shogi: Shogi, tesuu: number, moveFormats: IMoveFormat[]): KifuTreeNode {
