...
import KifuTreeComponent, { KifuTreeStateProps } from "../components/tree/KifuTree";
...
const mapStateToProps = () => {
  ...
  return (state: KifuTreeState): KifuTreeStateProps => {
    ...
    const currentPathChanged =
      !prevProps || !Immutable.is(state.kifuTree.currentPath, prevProps.kifuTree.currentPath);
